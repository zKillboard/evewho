...
CREATE TABLE `ew_alliances` (
  ...
  `lastUpdated` timestamp NULL DEFAULT '1970-01-01 00:00:01',
...
CREATE TABLE `ew_characters` (
  ...
  `lastUpdated` timestamp NOT NULL DEFAULT '1970-01-01 00:00:01',
  `history_added` tinyint(1) NOT NULL DEFAULT '0',
  `lastAffUpdated` timestamp NOT NULL DEFAULT '1970-01-01 00:00:01',
  `recent_change` int DEFAULT '1',
  `lastEmploymentChange` timestamp NOT NULL DEFAULT '1970-01-01 00:00:01',
