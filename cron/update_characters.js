...
async function f(app) {
    ...
    let chars = await app.mysql.query('select character_id, name from ew_characters where recent_change = 1 and lastUpdated < date_sub(now(), interval 1 day) order by lastUpdated limit 2000');
