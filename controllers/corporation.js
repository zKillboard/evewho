...
async function getData(req, res) {
  ...
  o.details = details[0];
  o.characters = await req.app.mysql.query('select ew.character_id id, name, date_format(start_date, "%Y/%m/%d %H:%i") start_date from ew_characters ew left join ew_history eh on ew.character_id = eh.character_id where ew.corporation_id = 98409330 and eh.corporation_id = 98409330 and end_date is null order by name, start_date desc limit 5000', req.params.id, req.params.id);
